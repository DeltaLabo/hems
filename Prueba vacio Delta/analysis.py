...
hems = pd.read_csv('Prueba vacio Delta/hems.csv',names=['timestamp','sens','temp','pres','humi'],parse_dates=['timestamp'], infer_datetime_format=True)
quest = pd.read_csv('Prueba vacio Delta/questtemp.csv',parse_dates=['timestamp'], infer_datetime_format=True)
