...
if estado == "Discomfort":
        if radiacion_solar == "No":
            ...
            temp_radiante_media = st.number_input(
            "Ingrese la temperatura radiante media (°C)",
            min_value=10,
            max_value=40,
            value=18,
            step=1
            ...
            iclofanger = lista_clofanger[
            lista_clofanger["Ropa de trabajo"] == seleccion_clofanger
            ]["clo"].iloc[0]
