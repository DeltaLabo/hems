...
espClient.setCACert(ca_cert);        // Certificado del broker
espClient.setCertificate(client_cert); // Certificado del ESP32
espClient.setPrivateKey(client_key);   // Llave privada del ESP32
